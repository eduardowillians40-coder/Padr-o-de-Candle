...
export default function WyckoffStrategyPage() {
  ...
  const handleExecuteTrade = () => {
    router.push('/operations/new?strategy=WYCKOFF');
  };
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#050A15] p-6 rounded-2xl border border-slate-800">
                  <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2">QUALIDADE DO CICLO</p>
                  <p className={cn(
                    "text-2xl font-bold",
                ...
                <div className="bg-[#050A15] p-6 rounded-2xl border border-slate-800">
                  ...
                  <p className="text-2xl font-bold text-emerald-500">{result.score}/100</p>
                </div>
              </div>
